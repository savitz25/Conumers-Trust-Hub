...
- Ask HEAD: `26466fd043fafcbd3373c43c313242db1949d268`
- Mode: **prep** (prep -- nothing is certified GREEN by this run)
- Started: 2026-09-23T01:35:41.390Z
...
|---|---|---|---|---|---|---|---|
| CON-01 | general contractor in miami | SOURCE_BACKED_RESULT (SUPPORTED_RESULTS) 3245ms | no | trade=general; geo Miami, Florida -> Miami-Dade County, Florida | OPEN_TRUSTHUB_DESTINATION, OPEN_TRUSTHUB_DESTINATION, OPEN_TRUSTHUB_DESTINATION | not needed | **PASS** |
| CON-02 | roofers in broward | SOURCE_BACKED_RESULT (SUPPORTED_RESULTS) 601ms | no | trade=roofing; geo Broward County, Florida -> Broward County, Florida | OPEN_TRUSTHUB_DESTINATION, OPEN_TRUSTHUB_DESTINATION, OPEN_TRUSTHUB_DESTINATION | not needed | **PASS** |
| CON-03 | plumber in miami | SOURCE_BACKED_RESULT (SUPPORTED_RESULTS) 523ms | no | trade=plumbing; geo Miami, Florida -> Miami-Dade County, Florida | OPEN_TRUSTHUB_DESTINATION, OPEN_TRUSTHUB_DESTINATION, OPEN_TRUSTHUB_DESTINATION | not needed | **PASS** |
| CON-04 | verify contractor license CBC015082 | SOURCE_BACKED_RESULT (EXACT_IDENTITY) 2598ms | no | state_contractor_license:CBC015082; geo - -> - | OPEN_TRUSTHUB_DESTINATION, OPEN_TRUSTHUB_DESTINATION, OPEN_TRUSTHUB_DESTINATION | not needed | **PASS** |
| CON-05 | licensed electrician in boca raton | SOURCE_BACKED_RESULT (SUPPORTED_RESULTS) 805ms | no | trade=electrical; geo Boca Raton, Florida -> Palm Beach County, Florida | OPEN_TRUSTHUB_DESTINATION, OPEN_TRUSTHUB_DESTINATION, OPEN_TRUSTHUB_DESTINATION | not needed | **PASS** |
