...
export const ANALYTICS_EVENTS = {
  ...
  SEARCH_TERMINAL_OUTCOME: 'search_terminal_outcome',
  ...
  CLAIM_VALIDATION_STARTED: 'claim_validation_started',
  CLAIM_VALIDATION_FAILED: 'claim_validation_failed',
  CLAIM_STARTED: 'claim_started',
  CLAIM_COMPLETED: 'claim_completed',
  CLAIM_RECOVERY_VIEWED: 'claim_recovery_viewed',
  CLAIM_REVIEW_REQUESTED: 'claim_review_requested',
  MANAGE_BUSINESS_OPENED: 'manage_business_opened',
