...
export function validateCustomerProfile(handoff:HandoffPayload,profile:CustomerProfileRecord|null):AdapterResult {
  ...
  if((handoff.hub_id==='senior'||handoff.hub_id==='investor'||handoff.hub_id==='insurance') && profile.canonicalUrl!==handoff.canonical_profile_url) return {ok:false,code:'slug_mismatch'};
