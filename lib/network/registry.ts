 ...
 *
 * Specialists copy this contract into their own repos. They must not fetch
 * network configuration from Ask at runtime.
 */
...
export const CURRENT_NETWORK_HUB_ID: NetworkHubId = 'ask';
