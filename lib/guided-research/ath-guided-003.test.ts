...
//
// TH-DISCOVERY-002: likewise, an unsupported product/line-of-authority word ("life", "homeowners")
// no longer hard-blocks the underlying agency cohort to zero rows -- InsuranceTrustHub has no
