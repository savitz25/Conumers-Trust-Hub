...
test('ten-state routing metadata preserves asymmetric specialist coverage', () => {
  ...
  for (const state of ['US-NJ', 'US-CA', 'US-TX', 'US-WA', 'US-CO', 'US-VA', 'US-NY', 'US-IL', 'US-OR', 'US-PA', 'US-NC', 'US-OH']) assert.deepEqual([...coverage.jurisdictions[state].specialistPublished].sort(), [...HUB_IDS].sort());
