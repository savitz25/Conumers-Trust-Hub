...
test('ten-state routing metadata preserves asymmetric specialist coverage', () => {
  assert.deepEqual(Object.keys(coverage.jurisdictions), ['US-FL', 'US-NJ', 'US-CA', 'US-TX', 'US-WA', 'US-AZ', 'US-CO', 'US-VA', 'US-NY', 'US-IL', 'US-OR', 'US-PA', 'US-NC', 'US-OH', 'US-GA', 'US-MA', 'US-TN', 'US-NV']);
  ...
  for (const state of ['US-NJ', 'US-CA', 'US-TX', 'US-WA', 'US-CO', 'US-VA', 'US-NY', 'US-IL', 'US-OR', 'US-PA', 'US-NC', 'US-OH', 'US-GA', 'US-MA', 'US-TN', 'US-NV']) assert.deepEqual([...coverage.jurisdictions[state].specialistPublished].sort(), [...HUB_IDS].sort());
