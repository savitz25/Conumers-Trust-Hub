/**
 * TRUSTHUB_VISUAL_STANDARD_V1 — Ask reference tokens (repo-local).
 * Do not publish as a cross-repo npm package.
 * Source: docs/trusthub-network-visual-standard-v1.md
 */
...
/** Geometry addendum stamp (VISUAL-002 brand-mark lock). */
...
/**
 * Specialist accent for brackets / CTAs / navigator dots.
 * Accent may change; bracket geometry must not (see TH_MARK_CANONICAL_RULE).
 */
