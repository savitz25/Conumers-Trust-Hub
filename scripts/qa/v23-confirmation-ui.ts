...
const b:BrowserBindings={origin,registry:{environment:'isolated',isolatedBackendVerified:true,origins:{move:'http://127.0.0.1:4526',insurance:'http://127.0.0.1:4527',lender:'http://127.0.0.1:4528',contractor:'http://127.0.0.1:4530',senior:'http://127.0.0.1:4531',investor:'http://127.0.0.1:4532'}},now:Date.now,
