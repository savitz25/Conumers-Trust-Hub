#!/usr/bin/env node
/**
 * ATH-CA-002 12-question California live stress test.
...
const rows = JSON.parse(readFileSync(join(root, 'data/network/california-12-question-stress.json'), 'utf8'));
...
writeFileSync(join(root, 'data/network/california-12-question-live.json'), JSON.stringify(out, null, 2) + '\n');
