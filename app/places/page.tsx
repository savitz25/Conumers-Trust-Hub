...
export const metadata = createPageMetadata({
  ...
  description:
    'Florida Place Lens plus New Jersey, California, Texas, and Washington network gateways to specialist research. Capability is not a county grade.',
  path: '/places',
});
  ...
  return (
    <>
      <PageHeader
        ...
        description="Start with Florida Place Lens, enhanced counties where published, or the New Jersey, California, Texas, and Washington network gateways. Capability is not a market score."
      />
