  ...
  return <>
    ...
    <main className="container-page py-12">
      <section className="card-surface max-w-2xl p-6">
        <ClaimFunnelAnalytics event="claim_recovery_viewed" hub={sp.hub} resultState={category} />
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">Tell support which public Trust Hub profile and public identifier you were researching. Support can review classification, association, and authority questions, but cannot bypass claim security.</p>
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">Do not email passwords, magic links, session tokens, unnecessary identity documents, financial information, or other private evidence.</p>
        ...
        <div className="mt-4 flex flex-wrap gap-3"><Link className="btn-secondary" href="/ask">Find the profile again</Link><Link className="btn-secondary" href="/claim/what-claiming-means">What claiming means</Link></div>
      </section>
    </main>
  </>;
}
