...
const items=[['Control Center','/admin'],['Operations','/admin#operations'],['Data','/admin#data'],['Growth','/admin#growth'],['Audit','/admin/audit'],['Controls','/admin/controls'],['Settings','/admin/security']];
