      ...
      e instanceof HandoffError || e instanceof ClaimError
        ...
        : e && typeof e === 'object' && 'code' in e && typeof (e as { code: unknown }).code === 'string'
          ...
          : e instanceof Error
            ...
            : 'unavailable';
    const errorMap:Record<string,string>={unsupported_hub:'UNSUPPORTED_CUSTOMER_HUB',missing_profile:'PROFILE_NOT_FOUND',thin_profile:'PROFILE_NOT_PUBLIC',historical_profile:'PROFILE_NOT_PUBLIC',profile_not_public:'PROFILE_NOT_PUBLIC',slug_mismatch:'PROFILE_IDENTITY_MISMATCH',credential_mismatch:'PROFILE_IDENTITY_MISMATCH',unsupported_source:'PROFILE_CLASS_NOT_CLAIMABLE',expired:'HANDOFF_EXPIRED',reused_nonce:'HANDOFF_REPLAYED',malformed:'HANDOFF_INVALID',tampered:'HANDOFF_INVALID',wrong_audience:'HANDOFF_INVALID',unavailable:'SPECIALIST_VALIDATION_UNAVAILABLE',specialist_unavailable:'SPECIALIST_VALIDATION_UNAVAILABLE'};
